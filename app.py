...
app_ui = ui.page_fluid(
    ...
    ui.tags.head(
        ...
        /*
         * Only the scrolling Week table is exempted from the
         * generic 800px minimum. This prevents the browser from
         * stretching the 62px Week columns when there are fewer
         * weeks than the generic table minimum.
         */
